...
export class SenderExecutor {
  private connection: Connection;
  private keypair: Keypair;
  private senderUrl: string = "https://sender.helius-rpc.com/fast";
  ...
  async executeAndConfirm(
    ...
    try {
      ...
      if (transaction instanceof VersionedTransaction) {
        ...
        if (signTransaction) transaction.sign([this.keypair]);
      } else {
      ...
      const response = await axios.post(this.senderUrl, {
        jsonrpc: "2.0",
        id: 1,
